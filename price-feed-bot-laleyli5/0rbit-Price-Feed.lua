-- PID GfBvfpupWDjjQxTzj2NbNv6kt0NLRoVRi-VwBatlUZg
...
Send({Target= "O3SXXYqQCNTbBedJjsW6wkPnrKFZq8DPLkKjO7zhztE", Action = "Claim", Quest = "Price-Bot", User = ""})
